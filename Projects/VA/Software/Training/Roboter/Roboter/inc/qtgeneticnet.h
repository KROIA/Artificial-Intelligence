...
class QtGeneticNet
{
  ...
  /*  std::string configParameter(std::string paramName);
    ...
    void drawInputValue(bool displayInputValue);
    void drawHiddenValue(bool displayHiddenValue);
    void drawOutputValue(bool displayOutputValue);
    void drawHideValues();
...
private:
    ...
    std::vector<std::vector<QLabel*>    >hiddenLabel;
    std::vector<QLabel*>outputLabel;
    unsigned int _ValueLabelFontSize;
    bool _displayInputValue;
    bool _displayHiddenValue;
    bool _displayOutputValue;
