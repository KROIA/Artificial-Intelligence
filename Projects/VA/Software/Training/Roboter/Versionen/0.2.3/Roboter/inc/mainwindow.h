...
private slots:
  ...
  void ticksPerSecondTimerFunction();
 ...
 void on_displayInputValue_checkBox_toggled(bool checked);
 void on_displayHiddenValue_checkBox_toggled(bool checked);
 void on_displayOutputValue_checkBox_toggled(bool checked);
...
private:
  ...
  Config * netLog;
   ...
   //int           runtime
    ...
    //ticksPerSecond
    QTimer *ticksPerSecondTimer;
    unsigned int ticksPerSecondCounter;
    vector<float> ticksPerSecondList;
    float ticksPerSecond;
    unsigned int ticksPerSecondBufferSize;
